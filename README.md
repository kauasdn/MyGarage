...
<tr>
<td width="90">
<img src="https://github.com/user-attachments/assets/cd1ba671-aa08-40d5-ba62-da3442089e40" width="72">
</td>
<td>
...
**Motivo da escolha:**
- Biblioteca muito utilizada no mercado
- Facilita a criação de interfaces dinâmicas
...
**Motivo da escolha:**
- Permite criar APIs rápidas e eficientes
- Utiliza JavaScript tanto no frontend quanto no backend
...
- Muito utilizado em aplicações web profissionais
...
- Visualização do histórico do veículo  
